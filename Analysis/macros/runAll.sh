...
## fggRunJobs.py --load ../config/jobs_diphoton_runD.json     ../config/high_mass_analysis.py maxEvents=-1  -d full_analysis_spring15_7412v1_sync_${version} -n 10 -q 8nh -H &
## 
## 
...
## fggRunJobs.py --load ../config/jobs_photon_runD.json       ../config/high_mass_analysis.py maxEvents=-1  -d single_photon_spring15_7412v1_sync_${version} -n 10 -q 8nh -H &
...
fggRunJobs.py --load ../config/jobs_dielectron.json      ../config/high_mass_analysis.py maxEvents=-1  -d double_ele_spring15v825ns_sync_${version} -n 100 -q 8nh -H &
