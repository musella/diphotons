...
fggRunJobs.py --load ../config/jobs_diphoton_76.json     ../config/high_mass_analysis.py applyDiphotonCorrections=1 maxEvents=-1  -d full_analysis_moriond16v1_sync_${version}_data -n 200 -H -q 1nh  &
...
## fggRunJobs.py --load ../config/jobs_dielectron_76.json      ../config/high_mass_analysis.py applyDiphotonCorrections=1 maxEvents=-1  -d double_ele_moriond16v1_sync_${version}_data -n 200 -q 1nd -H &
