...
dir2016=full_analysis_spring16v2_sync_v6_ichep
lumi2016=12.9
...
./combine_maker.sh $dir2016 --lumi $lumi2016 --lumistr $lumi2016 --fit-name cic2016  $common_opts --fit-background --load lumi.json --label fit_paper --load-merge lumi_paper.json
