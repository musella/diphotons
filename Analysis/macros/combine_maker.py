                ...
                for comp in options.components :
                    ...
                    if(len(options.bias_func) != 0):
                        ...
                        if (not bias_name in options.bias_func.keys()):
                            ...
                            lumi_rooval = ROOT.RooRealVar("lumi", "lumi", float(options.luminosity), "fb");
                            lumi_rooval.setConstant()
                            ...
                            thetaBias= self.buildRooVar("thetaBias_%s_%s" % (comp,cat), [], importToWs=False )
                            thetaBias.setVal(0.)
...
#                            fit["sig_params"][signame].append( ("# %s " % nBias.GetName(), 0., nBias.getVal() ) )
    ...
    def generateParametricSignalNew(self,options,args):
        ...
        for coup,pdfs in options.parametric_signal_source_new["pdfs"].iteritems():
            ...
            for cat,name in pdfs.iteritems():
                ...
                print "----------------------------- Name of the PDF and CAT: ",name,cat
            ...
            for cat,name in pdfs.iteritems():  
                ...
                if options.store_fwhm_parametrization:
                    ...
                    if cat == "EBEB": p0 = workspace.arg("p0_"+cat).getVal()
                    if cat == "EBEE": p0 = workspace.arg("p0_"+cat).getVal()
                    if cat == "EBEB": p1 = workspace.arg("p1_"+cat).getVal()
                    if cat == "EBEE": p1 = workspace.arg("p1_"+cat).getVal()
                    if cat == "EBEB016": p0 = workspace.arg("p0_cat0").getVal()
                    if cat == "EBEE016": p0 = workspace.arg("p0_cat1").getVal()
                    if cat == "EBEB016": p1 = workspace.arg("p1_cat0").getVal()
                    if cat == "EBEE016": p1 = workspace.arg("p1_cat1").getVal()
                    if cat == "EBEB0T": p0 = workspace.arg("p0_cat0").getVal()
                    if cat == "EBEE0T": p0 = workspace.arg("p0_cat1").getVal()
                    if cat == "EBEB0T": p1 = workspace.arg("p1_cat0").getVal()
                    if cat == "EBEE0T": p1 = workspace.arg("p1_").getVal()
    ...
    def plotBkgFit(self,options,dset,pdf,obs,label,blabel=None,extra=None,bias_funcs=None,poissonErrs=True,plot_binning=None,logx=True,logy=True,
        ...
        ## ROOT.gPad.SetLeftMargin(0.12),ROOT.gPad.SetRightMargin(0.025),
