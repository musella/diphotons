...
def getDefaultConfig():
    ...
    variables=["mass","pt","rapidity","eta",
               ...
               "leadGainRatiosEnergy := leadingPhoton.energyAtStep('gainRatiosCentral')",
               "subLeadGainRatiosEnergy := subLeadingPhoton.energyAtStep('gainRatiosCentral')",
               ...
               "leadIsG6 := leadingPhoton.checkStatusFlag('kHasSwitchToGain6')",
               "subLeadIsG6 := subLeadingPhoton.checkStatusFlag('kHasSwitchToGain6')",
               "leadIsG1 := leadingPhoton.checkStatusFlag('kHasSwitchToGain1')",
               "subLeadIsG1 := subLeadingPhoton.checkStatusFlag('kHasSwitchToGain1')",
