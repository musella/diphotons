...
void makeDataMcPlots(float lumi, bool blindData=false, int signalFactor=1)
{
  ...
  files[0]="data/mergedFinal/DoubleEG.root";
  files[1]="data/mergedFinal/RSGravToGG_kMpl-01_M-1000.root";
  files[2]="data/mergedFinal/QCD.root";
  files[3]="data/mergedFinal/GJets.root";
  files[4]="data/mergedFinal/GGJets.root";
