...
################################################
InputFileName = "/afs/cern.ch/work/c/crovelli/public/TaP_fall15_Moriond16_v1/formattedZ/Formatted_DYLL_largeSample__all1pb.root"
...
process.GsfElectronToId = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
            ...
            #"RooCBExGaussShape::signalResPass(mass,meanP[0.0,-1.,1.],sigmaP[2.,0.01,3.1],alphaP[1.,0.01,5.0],nP[2.,0.1,50.000],sigmaP_2[1.000,0.1,15.00])",    # >30
            ...
            #"RooCBExGaussShape::signalResFail(mass,meanF[-1.5,-3.,-0.5],sigmaF[1.,0.01,5],alphaF[2.,0.01,8.0],nF[3,0.01,25.0],sigmaF_2[1.,0.001,3.000])",      # 150-500 
            ...
            #"RooCBExGaussShape::signalResPass(mass,meanP[0.0,-1.,1.],sigmaP[1.,0.01,5.0],alphaP[1.,0.01,50.0],nP[2.,0.1,50.000],sigmaP_2[1.000,0.01,15.00])",    # 30-50 
            #"RooCBExGaussShape::signalResPass(mass,meanP[1.,-3.,3.],sigmaP[1.,0.01,5.0],alphaP[1.,0.01,50.0],nP[2.,0.1,50.000],sigmaP_2[1.000,0.1,15.00])",      # 50-60
            #"RooCBExGaussShape::signalResPass(mass,meanP[-0.5,-3.,0.5],sigmaP[1.,0.01,5.0],alphaP[1.,0.01,50.0],nP[2.,0.1,50.000],sigmaP_2[1.000,0.1,15.00])",   # 60-500
            ...
            #"RooCBExGaussShape::signalResFail(mass,meanF[0.0,-1.,1.],sigmaF[3.,0.01,5.0],alphaF[1.,0.,5.0],nF[3,0.1,50.0],sigmaF_2[1.,0.001,15.000])",           # 30-50 
